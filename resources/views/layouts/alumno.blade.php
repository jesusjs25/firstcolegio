...
<body>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                class="sidebar-item {{ request()->routeIs('alumno.index') ? 'active' : '' }}">
                <a href="{{ route('alumno.index') }}" class='sidebar-link'>
            ...
            <li
                class="sidebar-item {{ request()->routeIs('alumno.materias') ? 'active' : '' }}">
                <a href="{{ route('alumno.materias') }}" class='sidebar-link'>
            ...
            <li
                class="sidebar-item {{ request()->routeIs('alumno.notas') ? 'active' : '' }}">
                <a href="{{ route('alumno.notas') }}" class='sidebar-link'>
            ...
            <li
                ...
                <a href="{{ url('/alumno') }}" class='sidebar-link'>
