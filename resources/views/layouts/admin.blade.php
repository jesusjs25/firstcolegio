                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-center ">
                                    <div class="stats-icon purple mb-2 d-flex align-items-center justify-content-center float-none mx-auto">
                                        <x-heroicon-s-academic-cap class="w-4 h-4 text-white"/>
                                    </div>
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{ $totalProfesores }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-6 col-lg-3 col-md-6">
                    <div class="card">
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-center ">
                                    <div class="stats-icon green mb-2 d-flex align-items-center justify-content-center float-none mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    <h6 class="text-muted font-semibold">Materias</h6>
                                    <h6 class="font-extrabold mb-0">{{ $totalMaterias }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    var dataEstudiantesMensual = @json($chartData);
</script>
