    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Ruta: /alumno/dashboard</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-8 col-xxl-7">
                                ...
                                <h6 class="font-extrabold mb-0">{{ $materias_inscritas ?? '0' }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-8 col-xxl-7">
                                <h6 class="text-muted font-semibold">Próximos Horarios</h6>
                                <h6 class="font-bold mb-0 text-truncate" style="font-size: 0.9rem;">{{ $proximos_horarios ?? 'Sin asignar' }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-8 col-xxl-7">
                                <h6 class="text-muted font-semibold">Últimas Notas</h6>
                                <h6 class="font-bold mb-0 text-truncate" style="font-size: 0.85rem;">{{ $ultimas_notas ?? 'Ninguna' }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
